...
const schQuestions = [
  ...
  {
    question:
      "Are you having trouble hearing things or are you hearing things that aren't there?",
    response: responseType.yesNo,
  },
  { question: "Do you feel extremely tired?", response: responseType.yesNo },
  // mood disorder
  {
    question: "Are the happy thoughts speeding up your thought process?",
    response: responseType.yesNo,
  },
  {
    question: "Are the sad thoughts slowing down your thought process?",
    response: responseType.yesNo,
  },
  {
    question: "Are you having any grandiose thoughts?",
    response: responseType.yesNo,
  },
];

const impairmentQuestions = [
  // an array of objects -
  { question: "What is the Weekday?", response: responseType.weekday },
  {
    question: "Type in the first three things you see",
    response: responseType.userInput,
  },
  ...
  {
    question: "What were the three things you typed in before",
    response: responseType.userInput,
  },
...
const addictionQuestions = [
  ...
  {
    question: "Are you using substances as soon as you wake up in the morning?",
    response: responseType.yesNo,
  },
]; // 6 questions
